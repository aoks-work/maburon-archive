...
const archive_2018 = ({ data }) => {
  ...
  <Layout>
    ...
    <h3 className={link_styles.pageMonth}>5月</h3>
...
export const data = graphql`
    query {
      allYearOf2018Json(filter: {month: {eq: "5"}}) {
    edges {
      node {
        month
        playlistUrl
...
export const Head = () => <Seo title="2018年アーカイブ" />

export default archive_2018
