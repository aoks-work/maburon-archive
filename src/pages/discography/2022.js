...
const archive_2022 = ({ data }) => {
  ...
  <Layout>
    ...
    <h3>2月</h3>
    {data.allYearOf2022Json.edges.map(({ node }) => (
...
export const data = graphql`
    query {
      allYearOf2022Json(filter: {month: {eq: "2"}}) {
    edges {
      node {
        month
        playlistUrl
...
export const Head = () => <Seo title="2022年アーカイブ" />

export default archive_2022
